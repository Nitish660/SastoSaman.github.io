...
import payimg from '../../images/Footer/pay.png'
    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>SastoSaman is a leading online grocery store in the Nepal. We are committed to providing the best quality products at the best prices.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2023 SastoSaman, Inc.  All rights reserved</h3>
